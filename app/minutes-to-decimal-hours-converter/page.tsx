...
export const metadata = pageMetadata({
  ...
  description: "Convert a count of minutes into decimal hours for billing, time logs, and payroll. Free, instant, no sign-up required.",
  path: "/minutes-to-decimal-hours-converter",
  absoluteTitle: false,
});
